...
npm install
Provide Firebase config via environment variables (recommended) or edit src/firebase.js:
...
src/firebase.js contains fallback config values but you should set environment variables for production usage. See src/firebase.js for the keys used.
...
Create a .env file at the frontend/ folder with the following variables (replace values):
