...
const SLIDES = [
  {
    ...
    accent:   '#fbbf24',
    tag:      '🥔  අල ගොවිතැන · Potato Farming — Sri Lanka',
    title:    'ශ්‍රී ලංකාවේ අල ගොවිතැන',
  ...
  },
  {
    ...
    accent:   '#86efac',
    tag:      '🌱  Potato Plant Growth · Maha & Yala Seasons',
    title:    'බීජ අල සිට අස්වනු දක්වා',
  ...
  },
  {
    ...
    title:    'ඌව නිම්නයේ අල සඳහා මකුළු',
  ...
  },
  {
    ...
    accent:   '#c084fc',
    tag:      '📊  Fertilizer · Reports · ඉතිහාසය',
...
export default function SoilHealth() {
  ...
  const GaugeCard = ({ label, value, unit, paramKey, optimal }) => {
    ...
    return (
      <div className={`rounded-2xl border-2 p-4 flex flex-col gap-2 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 ${sc.ring}`}>
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-10">
      ...
      {(() => {
        ...
        return (
          <div className="relative overflow-hidden rounded-2xl shadow-2xl" style={{ height: '285px' }}>
            ...
            {/* Content */}
            <div className={`relative h-full flex flex-col justify-end px-7 pb-11 transition-all duration-500 ${slideAnim ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'}`}>
              <span
      ...
      {/* ============================================================
          HERO HEADER
          ============================================================ */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-700 via-green-600 to-emerald-500 text-white p-6 shadow-lg">
      ...
      {liveStatus === 'live' && outOfRangeAlerts.length > 0 && (
        <div className="rounded-2xl border border-red-300 bg-red-50 p-4 flex gap-3 items-start">
      ...
      {activeTab === 'live' && (
        <div className="space-y-5">
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-gradient-to-r from-green-600 to-emerald-500 text-white font-bold text-base hover:from-green-700 hover:to-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg shadow-green-200 hover:shadow-xl hover:-translate-y-0.5 flex items-center justify-center gap-3"
          >
            {predicting ? (
              <>
      ...
      {activeTab === 'manual' && (
        <form onSubmit={handlePredictManual} className="space-y-5">
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-gradient-to-r from-green-600 to-emerald-500 text-white font-bold text-base hover:from-green-700 hover:to-emerald-600 disabled:opacity-50 transition-all duration-200 shadow-lg shadow-green-200 hover:shadow-xl hover:-translate-y-0.5 flex items-center justify-center gap-3"
          >
            {predicting ? (
              <>
                <span className="w-5 h-5 rounded-full border-2 border-white border-t-transparent animate-spin" />
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5 ml-8">Last 20 analyses saved to your account</p>
            </div>
            <button
              onClick={loadHistory}
          ...
          {historyLoading && (
            <div className="text-center py-14 text-sm text-gray-400 flex flex-col items-center gap-3">
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      {predError && (
        <div className="bg-red-50 border border-red-300 text-red-700 text-sm rounded-2xl p-4 flex items-start gap-3">
